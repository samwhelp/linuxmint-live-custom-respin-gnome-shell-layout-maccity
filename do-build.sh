...
TARGET_ARCH="amd64"
TARGET_NAME="linuxmint-gnome-shell-layout-maccity"
TARGET_BUSINESS_NAME="LinuxMint-Gnome-Shell-Layout-Maccity"
TARGET_HOSTNAME="linuxmint-gnome-shell-layout-maccity"
...
TARGET_LINUXMINT_CODENAME="${TARGET_LINUXMINT_CODENAME}"
TARGET_LINUXMINT_MIRROR="${TARGET_LINUXMINT_MIRROR}"
...
function core_var_dump () {
	...
	echo "TARGET_LINUXMINT_CODENAME=\${TARGET_LINUXMINT_CODENAME}"
	echo "TARGET_LINUXMINT_MIRROR=\${TARGET_LINUXMINT_MIRROR}"
...
function core_var_export () {
	...
	export TARGET_LINUXMINT_CODENAME
	export TARGET_LINUXMINT_MIRROR
...
function sys_linuxmint_add_apt_sources () {
	...
	local target_linuxmint_codename="\${TARGET_LINUXMINT_CODENAME}"
	local target_linuxmint_mirror="\${TARGET_LINUXMINT_MIRROR}"
